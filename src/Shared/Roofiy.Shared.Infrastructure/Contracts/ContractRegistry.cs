...
using Roofiy.Shared.Abstractions.Contracts;
using Roofiy.Shared.Abstractions.Messaging;
using Roofiy.Shared.Infrastructure.Modules;
using Microsoft.Extensions.Logging;

namespace Roofiy.Shared.Infrastructure.Contracts;
    ...
    private void ValidateContract(Type contractType, string path = null)
    {
        ...
        var originalType = _types
            .Where(x => x.FullName is not null &&
                        x.FullName.Contains($"Roofiy.Modules.{module}", StringComparison.InvariantCultureIgnoreCase))
